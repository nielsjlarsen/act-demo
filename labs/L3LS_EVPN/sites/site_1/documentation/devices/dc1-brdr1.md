...
| -------------------- | ----------- | ---- | --- | ---------- | ------- |
| Management1 | ACT OOB Management | oob | default | 192.168.0.100/24 | 192.168.0.1 |
...
| --------- | --------------- | ------------ | --------- |
| DC1_BRDR | Vlan4094 | 10.251.1.9 | Port-Channel1 |
...
| --------- | ----------- | ---- | ----- | ----------- | ----------- | ------------- |
| Ethernet1 | MLAG_dc1-brdr2_Ethernet1 | *trunk | *- | *- | *MLAG | 1 |
| Ethernet6 | MLAG_dc1-brdr2_Ethernet6 | *trunk | *- | *- | *MLAG | 1 |
...
| --------- | ----------- | ------------- | ---------- | ----| ---- | -------- | ------ | ------- |
| Ethernet2 | P2P_dc1-spine1_Ethernet7 | - | 172.16.1.17/31 | default | 1500 | False | - | - |
| Ethernet3 | P2P_dc1-spine2_Ethernet7 | - | 172.16.1.19/31 | default | 1500 | False | - | - |
...
!
interface Ethernet1
   description MLAG_dc1-brdr2_Ethernet1
   no shutdown
...
!
interface Ethernet6
   description MLAG_dc1-brdr2_Ethernet6
   no shutdown
   channel-group 1 mode active
```
...
| --------- | ----------- | ---- | ----- | ----------- | ------------| --------------------- | ------------------ | ------- | -------- |
| Port-Channel1 | MLAG_dc1-brdr2_Port-Channel1 | trunk | - | - | MLAG | - | - | - | - |
...
interface Port-Channel1
   description MLAG_dc1-brdr2_Port-Channel1
   no shutdown
...
router bgp 65103
   ...
   neighbor MLAG-IPv4-UNDERLAY-PEER description dc1-brdr2
   ...
   vrf OVERLAY
      ...
      router-id 10.250.1.7
      neighbor 10.252.1.9 peer group MLAG-IPv4-UNDERLAY-PEER
      neighbor 10.252.1.9 description dc1-brdr2_Vlan3009
