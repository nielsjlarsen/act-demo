...
| -------------------- | ----------- | ---- | --- | ---------- | ------- |
| Management1 | ACT OOB Management | oob | default | 192.168.0.12/24 | 192.168.0.1 |
...
| --------- | --------------- | ------------ | --------- |
| DC1_RACK1 | Vlan4094 | 10.251.1.1 | Port-Channel1 |
...
| --------- | ----------- | ---- | ----- | ----------- | ----------- | ------------- |
| Ethernet1 | MLAG_dc1-leaf2_Ethernet1 | *trunk | *- | *- | *MLAG | 1 |
| Ethernet4 | L2_dc1-l2leaf1_Ethernet1 | *trunk | *10,20 | *- | *- | 4 |
| Ethernet6 | MLAG_dc1-leaf2_Ethernet6 | *trunk | *- | *- | *MLAG | 1 |
...
| --------- | ----------- | ------------- | ---------- | ----| ---- | -------- | ------ | ------- |
| Ethernet2 | P2P_dc1-spine1_Ethernet2 | - | 172.16.1.1/31 | default | 1500 | False | - | - |
| Ethernet3 | P2P_dc1-spine2_Ethernet2 | - | 172.16.1.3/31 | default | 1500 | False | - | - |
...
!
interface Ethernet1
   description MLAG_dc1-leaf2_Ethernet1
   no shutdown
...
!
interface Ethernet4
   description L2_dc1-l2leaf1_Ethernet1
   no shutdown
...
| --------- | ----------- | ---- | ----- | ----------- | ------------| --------------------- | ------------------ | ------- | -------- |
| Port-Channel1 | MLAG_dc1-leaf2_Port-Channel1 | trunk | - | - | MLAG | - | - | - | - |
| Port-Channel4 | L2_dc1-l2leaf1_Port-Channel1 | trunk | 10,20 | - | - | - | - | 4 | - |
...
interface Port-Channel1
   description MLAG_dc1-leaf2_Port-Channel1
   no shutdown
...
interface Port-Channel4
   description L2_dc1-l2leaf1_Port-Channel1
   no shutdown
...
| --------- | --- | ---------- | ------------------ | ------------------------- | ------ | ------- |
| Vlan10 |  OVERLAY  |  -  |  10.10.100.1/24  |  -  |  -  |  -  |
| Vlan20 |  OVERLAY  |  -  |  10.10.200.1/24  |  -  |  -  |  -  |
...
router bgp 65101
   ...
   vrf OVERLAY
      ...
      router-id 10.250.1.3
      neighbor 10.252.1.1 peer group MLAG-IPv4-UNDERLAY-PEER
      neighbor 10.252.1.1 description dc1-leaf2_Vlan3009
