...
| -------------------- | ----------- | ---- | --- | ---------- | ------- |
| Management1 | ACT OOB Management | oob | default | 192.168.0.13/24 | 192.168.0.1 |
...
| --------- | --------------- | ------------ | --------- |
| DC1_RACK1 | Vlan4094 | 10.251.1.0 | Port-Channel1 |
...
| Ethernet4 | L2_dc1-l2leaf1_Ethernet2 | *trunk | *10,20 | *- | *- | 4 |
| Ethernet6 | MLAG_dc1-leaf1_Ethernet6 | *trunk | *- | *- | *MLAG | 1 |
...
| --------- | ----------- | ------------- | ---------- | ----| ---- | -------- | ------ | ------- |
| Ethernet2 | P2P_dc1-spine1_Ethernet3 | - | 172.16.1.5/31 | default | 1500 | False | - | - |
| Ethernet3 | P2P_dc1-spine2_Ethernet3 | - | 172.16.1.7/31 | default | 1500 | False | - | - |
...
!
interface Ethernet4
   description L2_dc1-l2leaf1_Ethernet2
   no shutdown
   channel-group 4 mode active
!
interface Ethernet6
   description MLAG_dc1-leaf1_Ethernet6
   no shutdown
   channel-group 1 mode active
```
...
router bgp 65101
   ...
   vrf OVERLAY
      ...
      router-id 10.250.1.4
      neighbor 10.252.1.0 peer group MLAG-IPv4-UNDERLAY-PEER
      neighbor 10.252.1.0 description dc1-leaf1_Vlan3009
