...
| -------------------- | ----------- | ---- | --- | ---------- | ------- |
| Management1 | ACT OOB Management | oob | default | 192.168.0.101/24 | 192.168.0.1 |
...
| --------- | --------------- | ------------ | --------- |
| DC1_BRDR | Vlan4094 | 10.251.1.8 | Port-Channel1 |
...
| --------- | ----------- | ---- | ----- | ----------- | ----------- | ------------- |
| Ethernet1 | MLAG_dc1-brdr1_Ethernet1 | *trunk | *- | *- | *MLAG | 1 |
| Ethernet6 | MLAG_dc1-brdr1_Ethernet6 | *trunk | *- | *- | *MLAG | 1 |
...
| --------- | ----------- | ------------- | ---------- | ----| ---- | -------- | ------ | ------- |
| Ethernet2 | P2P_dc1-spine1_Ethernet8 | - | 172.16.1.21/31 | default | 1500 | False | - | - |
| Ethernet3 | P2P_dc1-spine2_Ethernet8 | - | 172.16.1.23/31 | default | 1500 | False | - | - |
...
!
interface Ethernet1
   description MLAG_dc1-brdr1_Ethernet1
   no shutdown
...
!
interface Ethernet6
   description MLAG_dc1-brdr1_Ethernet6
   no shutdown
   channel-group 1 mode active
```
...
| --------- | ----------- | ---- | ----- | ----------- | ------------| --------------------- | ------------------ | ------- | -------- |
| Port-Channel1 | MLAG_dc1-brdr1_Port-Channel1 | trunk | - | - | MLAG | - | - | - | - |
...
interface Port-Channel1
   description MLAG_dc1-brdr1_Port-Channel1
   no shutdown
...
router bgp 65103
   ...
   vrf OVERLAY
      ...
      router-id 10.250.1.8
      neighbor 10.252.1.8 peer group MLAG-IPv4-UNDERLAY-PEER
      neighbor 10.252.1.8 description dc1-brdr1_Vlan3009
