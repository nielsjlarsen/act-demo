...
| -------------------- | ----------- | ---- | --- | ---------- | ------- |
| Management1 | ACT OOB Management | oob | default | 192.168.0.14/24 | 192.168.0.1 |
...
| --------- | --------------- | ------------ | --------- |
| DC1_RACK2 | Vlan4094 | 10.251.1.5 | Port-Channel1 |
...
| --------- | ----------- | ---- | ----- | ----------- | ----------- | ------------- |
| Ethernet1 | MLAG_dc1-leaf4_Ethernet1 | *trunk | *- | *- | *MLAG | 1 |
| Ethernet4 | L2_dc1-l2leaf2_Ethernet1 | *trunk | *10,20 | *- | *- | 4 |
| Ethernet6 | MLAG_dc1-leaf4_Ethernet6 | *trunk | *- | *- | *MLAG | 1 |
...
| --------- | ----------- | ------------- | ---------- | ----| ---- | -------- | ------ | ------- |
| Ethernet2 | P2P_dc1-spine1_Ethernet4 | - | 172.16.1.9/31 | default | 1500 | False | - | - |
| Ethernet3 | P2P_dc1-spine2_Ethernet4 | - | 172.16.1.11/31 | default | 1500 | False | - | - |
...
!
interface Ethernet4
   description L2_dc1-l2leaf2_Ethernet1
   no shutdown
   channel-group 4 mode active
!
interface Ethernet6
   description MLAG_dc1-leaf4_Ethernet6
   no shutdown
   channel-group 1 mode active
```
...
| --------- | ----------- | ---- | ----- | ----------- | ------------| --------------------- | ------------------ | ------- | -------- |
| Port-Channel1 | MLAG_dc1-leaf4_Port-Channel1 | trunk | - | - | MLAG | - | - | - | - |
...
router bgp 65102
   ...
   vrf OVERLAY
      ...
      router-id 10.250.1.5
      neighbor 10.252.1.5 peer group MLAG-IPv4-UNDERLAY-PEER
      neighbor 10.252.1.5 description dc1-leaf4_Vlan3009
